/*
MPU9250
Original Author: Kris Winer (April 2014)
Update: Tinker Twins (March 2021)

SUMMARY:
This code includes parameterizing the register addresses, initializing the sensor, and extracting properly
scaled accelerometer, gyroscope, and magnetometer data out. Additionally, this code also implements open
source Madgwick and Mahony filter algorithms to produce a quaternion-based estimate of absolute device
orientation, which can be converted to roll, pitch and yaw.

HARDWARE:
This code has been tested on Arduino Nano V3 and MPU9250 breakout board.
The MPU9250 breakout board comprises of the following sensors:
  - MPU6050:  Accelerometer + Gyroscope + Thermometer
  - AK8963:   Magnetometer
Note: The breakout board had external pull-up resistors and was 5V tolerant.
...
Note: The Arduino Wire library was not modified.
*/
//======================================================================================================================================================================
// LIBRARIES
//======================================================================================================================================================================
...
float   magBias[3] = {0, 0, 0};   // Stores the magnetometer bias corrections (may be initialized using values from previous calibration)
...
float magDeclination = 1.34; /* Declination at Potheri, Chennai, India
                             ...
                             */
uint32_t delt_t = 0, count = 0; // Parammeters to control display output rate
  ...
  */
  if(dataFiltering) {
    ...
    */
    ...
    // Update display at 2 Hz
    if(serialDebug & (delt_t > 500)) {
      Serial.print("Roll Pitch Yaw:\t"); Serial.print(roll, 2); Serial.print("\t"); Serial.print(pitch, 2); Serial.print("\t"); Serial.print(yaw+180, 2); Serial.println("\tdeg");
      count = millis();
    }
  }
}
